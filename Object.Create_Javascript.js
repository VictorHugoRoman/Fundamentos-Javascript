/*Object.Create
continuando con el mismo ejemplo de la clase anterior(Prototipos) de calcular la distancia entre dos puntos
en esta ocacion lo aremos usando object.create
*/


const Punto = {//creamos un objeto de tipo punto
  init:functioninit(x, y){//usamos init como el constructor de nuestro objeto
  ...
  distancia: function(p){//creamos la funcion distancia
    const x = this.x -p.x
    const y = this.y -p.y
    returnMath.sqrt(x * x + y * y )//retornamos la distancia
  }
}
